...
<body>
  <div class="flexBtn">
    <header onclick="dropclose()">
      ...
      <?php  if (isset($_SESSION['username'])) : ?>
         <a href="usprofile.php?logout='1'" class="btnR btns">Sign Out</a> 
        <?php endif ?>
  ...
  <div class="passport">
    <div class="pass-infous">
      ...
      <ul>
        <button class="takeNow btns1" type="submit" name="registerbutton" onclick="showRegister()"><a id="backtogame" href="../html/game.html">Take Mission</a></button>
      </div>
    </div>
  </div>
  <div>
